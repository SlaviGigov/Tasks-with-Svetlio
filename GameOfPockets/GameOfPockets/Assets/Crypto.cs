    ...
    public class Crypto : Asset
    {
        ...
        public override void Update(int assetValue, int GDPrate)
        {
            switch (GDPrate)
            {
                ...
                case -3: Value = (int)(assetValue * 0.55); break;
                case 0: Value = (int)(assetValue * 0.85); break;
                case +3: Value = (int)(assetValue * 1.1); break;
                case +5: Value = (int)(assetValue * 1.25); break;
                case +10: Value = (int)(assetValue * 1.55); break;
            }
        }
    }
}
